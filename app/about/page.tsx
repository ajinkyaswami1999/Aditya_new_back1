        ...
        <section className="py-20 bg-gradient-to-b from-black to-gray-900">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto fade-in">
                We are a forward-thinking architecture studio dedicated to creating spaces that
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="fade-in">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Founded in 2012, 26AS Design Studio emerged from a shared vision to revolutionize
                  architectural design through innovative thinking and sustainable practices. Our
                  journey began with a simple belief: that great architecture has the power to
                  transform lives and communities.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Over the years, we've grown from a small team of passionate architects to a
                  comprehensive design studio, working on projects ranging from intimate residential
                  spaces to large-scale commercial developments.
                </p>
              </div>
              <div className="fade-in">
                <img
        ...
        <section className="py-20 bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto slide-up">
                Our diverse team of architects, designers, and engineers brings together decades of
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {teamMembers.map((member, index) => (
                  ...
                  >
                    <div className="w-32 h-32 mx-auto mb-6 overflow-hidden rounded-full border-4 border-yellow-400/50 hover:border-yellow-400 transition-all duration-300">
                      <ImageWithFallback src={member.image_url} alt={member.name} name={member.name} />
                    </div>
                    <h3 className="text-xl font-medium mb-2 text-white">{member.name}</h3>
                    <p className="text-yellow-400 font-medium mb-4">{member.position}</p>
                    {member.bio && (
